  ...
  return (
    <section id="home" className="min-h-screen pt-32 pb-20 px-6 flex items-center justify-center overflow-hidden relative">
      ...
      <div className="max-w-6xl w-full mx-auto grid md:grid-cols-2 gap-12 items-center relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/60 dark:bg-slate-800/60 border border-white/50 dark:border-slate-700/50 backdrop-blur-sm shadow-sm text-sm font-medium text-pink-500 mb-6">
            <Sparkles size={14} />
            <span>Available for commissions</span>
          </div>
          
          <h1 className="text-5xl md:text-7xl font-extrabold text-slate-800 dark:text-white tracking-tight leading-[1.1] mb-6 transition-colors">
          ...
          <p className="text-lg md:text-xl text-slate-600 dark:text-slate-300 mb-8 max-w-lg mx-auto md:mx-0 leading-relaxed transition-colors">
            Hi, I'm <span className="font-bold text-slate-800 dark:text-white">Rollie</span>. I produce Anime-style, OPM, and Classical fusion music that tells a story. Let's make your next track unforgettable.
          </p>
          
          <div className="flex flex-col sm:flex-row items-center gap-4 justify-center md:justify-start">
            <Link to="/demos" className="px-8 py-4 bg-slate-900 dark:bg-white text-white dark:text-slate-900 rounded-full font-bold shadow-lg shadow-slate-200 dark:shadow-slate-900/50 hover:bg-slate-800 dark:hover:bg-slate-200 hover:scale-105 active:scale-95 transition-all flex items-center gap-2">
          ...
          <div className="mt-12 flex items-center gap-8 justify-center md:justify-start grayscale opacity-50 hover:grayscale-0 hover:opacity-100 transition-all duration-500 dark:opacity-40 dark:hover:opacity-100">
             ...
             <div className="font-bold text-xl text-slate-800 dark:text-white">SoundCloud</div>
             <div className="font-bold text-xl text-slate-800 dark:text-white">Spotify</div>
             <div className="font-bold text-xl text-slate-800 dark:text-white">YouTube</div>
          </div>
        </motion.div>
        ...
        >
           <div className="relative aspect-square md:aspect-[4/5] w-full max-w-md mx-auto">
              ...
              <img 
                ...
                className="w-full h-full object-cover rounded-[2.5rem] shadow-2xl border-4 border-white dark:border-slate-700 transform hover:-translate-y-2 transition-transform duration-500"
              />
              ...
              <motion.div 
                ...
                className="absolute -bottom-6 -left-6 bg-white dark:bg-slate-800 p-4 rounded-2xl shadow-xl border border-pink-100 dark:border-slate-700 flex items-center gap-3 max-w-[200px]"
              >
                <div className="w-10 h-10 bg-pink-100 dark:bg-pink-900/30 rounded-full flex items-center justify-center text-pink-500">
                  <Play size={20} fill="currentColor" />
                </div>
                <div>
                  <div className="text-xs text-slate-400 dark:text-slate-400 font-medium">Now Playing</div>
                  <div className="text-sm font-bold text-slate-800 dark:text-white">Summer Rain</div>
                </div>
              </motion.div>
           </div>
        </motion.div>
